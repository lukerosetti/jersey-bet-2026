...
const regions = {
  east: {
    name: 'East',
    games: [
      { id: 'e1', round: 1, s1: 1, t1: 'Duke', s2: 16, t2: 'Siena', status: 'upcoming', tip: 'Thu 2:50 PM', network: 'CBS' },
      { id: 'e2', round: 1, s1: 8, t1: 'Ohio State', s2: 9, t2: 'TCU', status: 'upcoming', tip: 'Thu 12:15 PM', network: 'CBS' },
      { id: 'e3', round: 1, s1: 5, t1: 'St Johns', s2: 12, t2: 'Northern Iowa', status: 'upcoming', tip: 'Fri 7:10 PM', network: 'CBS' },
      { id: 'e4', round: 1, s1: 4, t1: 'Kansas', s2: 13, t2: 'Cal Baptist', status: 'upcoming', tip: 'Fri 9:45 PM', network: 'CBS' },
      { id: 'e5', round: 1, s1: 6, t1: 'Louisville', s2: 11, t2: 'South Florida', status: 'upcoming', tip: 'Thu 1:30 PM', network: 'TNT' },
      { id: 'e6', round: 1, s1: 3, t1: 'Michigan St', s2: 14, t2: 'North Dakota St', status: 'upcoming', tip: 'Thu 4:05 PM', network: 'TNT' },
      { id: 'e7', round: 1, s1: 7, t1: 'UCLA', s2: 10, t2: 'UCF', status: 'upcoming', tip: 'Fri 7:25 PM', network: 'TBS' },
      { id: 'e8', round: 1, s1: 2, t1: 'UConn', s2: 15, t2: 'Furman', status: 'upcoming', tip: 'Fri 10:00 PM', network: 'TBS' },
  ...
  west: {
    name: 'West',
    games: [
      { id: 'w1', round: 1, s1: 1, t1: 'Arizona', s2: 16, t2: 'LIU', status: 'upcoming', tip: 'Fri 1:35 PM', network: 'TNT' },
      { id: 'w2', round: 1, s1: 8, t1: 'Villanova', s2: 9, t2: 'Utah State', status: 'upcoming', tip: 'Fri 4:10 PM', network: 'TNT' },
      { id: 'w3', round: 1, s1: 5, t1: 'Wisconsin', s2: 12, t2: 'High Point', status: 'upcoming', tip: 'Thu 1:50 PM', network: 'TBS' },
      { id: 'w4', round: 1, s1: 4, t1: 'Arkansas', s2: 13, t2: 'Hawaii', status: 'upcoming', tip: 'Thu 4:25 PM', network: 'TBS' },
      { id: 'w5', round: 1, s1: 6, t1: 'BYU', s2: 11, t2: 'TBD', t2PlayIn: 'pi2', status: 'upcoming', tip: 'Thu 7:25 PM', network: 'TBS' },
      { id: 'w6', round: 1, s1: 3, t1: 'Gonzaga', s2: 14, t2: 'Kennesaw St', status: 'upcoming', tip: 'Thu 10:00 PM', network: 'TBS' },
      { id: 'w7', round: 1, s1: 7, t1: 'Miami FL', s2: 10, t2: 'Missouri', status: 'upcoming', tip: 'Fri 10:10 PM', network: 'TruTV' },
      { id: 'w8', round: 1, s1: 2, t1: 'Purdue', s2: 15, t2: 'Queens', status: 'upcoming', tip: 'Fri 7:35 PM', network: 'TruTV' },
  ...
  south: {
    name: 'South',
    games: [
      { id: 's1', round: 1, s1: 1, t1: 'Florida', s2: 16, t2: 'TBD', t2PlayIn: 'pi1', status: 'upcoming', tip: 'Fri 9:25 PM', network: 'TNT' },
      { id: 's2', round: 1, s1: 8, t1: 'Clemson', s2: 9, t2: 'Iowa', status: 'upcoming', tip: 'Fri 6:50 PM', network: 'TNT' },
      { id: 's3', round: 1, s1: 5, t1: 'Vanderbilt', s2: 12, t2: 'McNeese', status: 'upcoming', tip: 'Thu 3:15 PM', network: 'TruTV' },
      { id: 's4', round: 1, s1: 4, t1: 'Nebraska', s2: 13, t2: 'Troy', status: 'upcoming', tip: 'Thu 12:40 PM', network: 'TruTV' },
      { id: 's5', round: 1, s1: 6, t1: 'North Carolina', s2: 11, t2: 'VCU', status: 'upcoming', tip: 'Thu 6:50 PM', network: 'TNT' },
      { id: 's6', round: 1, s1: 3, t1: 'Illinois', s2: 14, t2: 'Penn', status: 'upcoming', tip: 'Thu 9:25 PM', network: 'TNT' },
      { id: 's7', round: 1, s1: 7, t1: 'Saint Marys', s2: 10, t2: 'Texas A&M', status: 'upcoming', tip: 'Thu 7:35 PM', network: 'TruTV' },
      { id: 's8', round: 1, s1: 2, t1: 'Houston', s2: 15, t2: 'Idaho', status: 'upcoming', tip: 'Thu 10:10 PM', network: 'TruTV' },
  ...
  midwest: {
    name: 'Midwest',
    games: [
      { id: 'm1', round: 1, s1: 1, t1: 'Michigan', s2: 16, t2: 'TBD', t2PlayIn: 'pi3', status: 'upcoming', tip: 'Thu 7:10 PM', network: 'CBS' },
      { id: 'm2', round: 1, s1: 8, t1: 'Georgia', s2: 9, t2: 'Saint Louis', status: 'upcoming', tip: 'Thu 9:45 PM', network: 'CBS' },
      { id: 'm3', round: 1, s1: 5, t1: 'Texas Tech', s2: 12, t2: 'Akron', status: 'upcoming', tip: 'Fri 12:40 PM', network: 'TruTV' },
      { id: 'm4', round: 1, s1: 4, t1: 'Alabama', s2: 13, t2: 'Hofstra', status: 'upcoming', tip: 'Fri 3:15 PM', network: 'TruTV' },
      { id: 'm5', round: 1, s1: 6, t1: 'Tennessee', s2: 11, t2: 'TBD', t2PlayIn: 'pi4', status: 'upcoming', tip: 'Fri 4:25 PM', network: 'TBS' },
      { id: 'm6', round: 1, s1: 3, t1: 'Virginia', s2: 14, t2: 'Wright St', status: 'upcoming', tip: 'Fri 1:50 PM', network: 'TBS' },
      { id: 'm7', round: 1, s1: 7, t1: 'Kentucky', s2: 10, t2: 'Santa Clara', status: 'upcoming', tip: 'Fri 12:15 PM', network: 'CBS' },
      { id: 'm8', round: 1, s1: 2, t1: 'Iowa State', s2: 15, t2: 'Tennessee St', status: 'upcoming', tip: 'Fri 2:50 PM', network: 'CBS' },
