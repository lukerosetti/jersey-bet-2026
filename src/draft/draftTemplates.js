...
const templates = {
  'masters-2026': {
    ...
    // Each entry: { name, country (ISO 3166-1 alpha-2), owgr, espnId (for headshots) }
    players: [
      { name: 'Scottie Scheffler', country: 'US', owgr: 1, espnId: 11610 },
      { name: 'Rory McIlroy', country: 'GB', owgr: 2, espnId: 3470 },
      { name: 'Xander Schauffele', country: 'US', owgr: 3, espnId: 10423 },
      { name: 'Collin Morikawa', country: 'US', owgr: 4, espnId: 11099 },
      { name: 'Ludvig Aberg', country: 'SE', owgr: 5, espnId: 12755 },
      { name: 'Jon Rahm', country: 'ES', owgr: 6, espnId: 9780 },
      { name: 'Bryson DeChambeau', country: 'US', owgr: 7, espnId: 10046 },
      { name: 'Viktor Hovland', country: 'NO', owgr: 8, espnId: 11252 },
      { name: 'Patrick Cantlay', country: 'US', owgr: 9, espnId: 9858 },
      { name: 'Tommy Fleetwood', country: 'GB', owgr: 10, espnId: 7121 },
      { name: 'Cameron Young', country: 'US', owgr: 11 },
      { name: 'Matt Fitzpatrick', country: 'GB', owgr: 12 },
      { name: 'Justin Rose', country: 'GB', owgr: 13, espnId: 1030 },
      { name: 'Hideki Matsuyama', country: 'JP', owgr: 14, espnId: 5860 },
      { name: 'Shane Lowry', country: 'IE', owgr: 15, espnId: 5581 },
      { name: 'Sam Burns', country: 'US', owgr: 16, espnId: 11104 },
      { name: 'Russell Henley', country: 'US', owgr: 17 },
      { name: 'Justin Thomas', country: 'US', owgr: 18, espnId: 9917 },
      ...
      { name: 'Adam Scott', country: 'AU', owgr: 33, espnId: 1040 },
      { name: 'Cameron Smith', country: 'AU', owgr: 34, espnId: 10007 },
      { name: 'Dustin Johnson', country: 'US', owgr: 35, espnId: 4686 },
      { name: 'Jordan Spieth', country: 'US', owgr: 36, espnId: 5765 },
      ...
      { name: 'Phil Mickelson', country: 'US', owgr: 68, espnId: 308 },
      { name: 'Sergio Garcia', country: 'ES', owgr: 69, espnId: 1040 },
      { name: 'Bubba Watson', country: 'US', owgr: 70, espnId: 780 },
      ...
      { name: 'Tiger Woods', country: 'US', owgr: 79, espnId: 462 },
